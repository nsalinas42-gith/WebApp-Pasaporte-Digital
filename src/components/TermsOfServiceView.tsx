...
export default function TermsOfServiceView({ onClose }: TermsOfServiceViewProps) {
  ...
  return (
    ...
    >
      {/* 1. TOP HEADER BAR */}
      <header id="terms-header" className="sticky top-0 w-full z-50 flex justify-between items-center px-4 sm:px-6 md:px-12 h-16 sm:h-20 bg-[#001621]/90 backdrop-blur-xl border-b border-[#005049]/35 shadow-[0_0_20px_rgba(26, 86, 219,0.04)]">
      ...
      <main id="terms-main-content" className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 md:px-12 py-12 sm:py-16 space-y-10">
        ...
        <div id="terms-title-block" className="space-y-4 text-center">
          <div id="terms-icon-wrapper" className="w-14 h-14 rounded-2xl bg-[#1A56DB]/10 border border-[#1A56DB]/20 flex items-center justify-center text-[#1A56DB] mx-auto mb-2">
            <FileText className="w-7 h-7 text-[#1A56DB]" />
          </div>
          ...
          <div id="terms-title-divider" className="w-16 h-1 bg-[#1A56DB] mx-auto rounded-full"></div>
        ...
        <div id="terms-content-box" className="bg-[#001721] border border-[#005049]/25 rounded-3xl p-6 sm:p-10 space-y-8 shadow-[0_10px_35px_rgba(0,0,0,0.4)]">
          ...
          <section id="terms-section-1-1" className="space-y-3 pt-2 text-left">
            <h3 className="font-headline text-lg font-black text-on-surface flex items-center gap-2">
              <span className="text-[#1A56DB] font-mono text-base">1.1.</span>
          ...
          <section id="terms-section-1-2" className="space-y-4 text-left">
            <h3 className="font-headline text-lg font-black text-on-surface flex items-center gap-2">
              <span className="text-[#1A56DB] font-mono text-base">1.2.</span>
          ...
          <section id="terms-section-1-3" className="space-y-3 text-left">
            <h3 className="font-headline text-lg font-black text-on-surface flex items-center gap-2">
              <span className="text-[#1A56DB] font-mono text-base">1.3.</span>
          ...
          <section id="terms-section-1-4" className="space-y-3 text-left">
            <h3 className="font-headline text-lg font-black text-on-surface flex items-center gap-2">
              <span className="text-[#1A56DB] font-mono text-base">1.4.</span>
          ...
          <section id="terms-section-1-5" className="space-y-3 text-left">
            <h3 className="font-headline text-lg font-black text-on-surface flex items-center gap-2">
              <span className="text-[#1A56DB] font-mono text-base">1.5.</span>
          ...
          <section id="terms-section-1-6" className="space-y-3 text-left">
            <h3 className="font-headline text-lg font-black text-on-surface flex items-center gap-2">
              <span className="text-[#1A56DB] font-mono text-base">1.6.</span>
