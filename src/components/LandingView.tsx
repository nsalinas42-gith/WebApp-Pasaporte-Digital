      ...
      <section className="relative w-full min-h-[95vh] flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-8 border-b border-[#005049]/20 overflow-hidden">
        ...
        <div className="relative z-20 text-center max-w-3xl mx-auto space-y-6 px-4 py-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button
              onClick={onEnter}
              className="w-full sm:w-auto px-8 py-4 bg-[#FFFFFF] hover:bg-[#F3F4F6] text-[#000f16] font-extrabold rounded-xl text-xs sm:text-sm uppercase tracking-wider shadow-[0_4px_20px_rgba(255,255,255,0.1)] hover:scale-[1.03] active:scale-[0.98] transition-all flex items-center justify-center gap-3.5 outline-none cursor-pointer border border-[#E5E7EB]"
            >
              <svg className="w-5 h-5 shrink-0 animate-pulse-slow" viewBox="0 0 24 24" width="24" height="24">
                <path
                  fill="#4285F4"
