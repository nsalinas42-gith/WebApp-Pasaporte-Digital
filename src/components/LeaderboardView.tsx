        ...
        {rankedEntries[0] && (
          <div className="bg-gradient-to-t from-surface-container-high to-[#0d2d3d]/80 border-2 border-secondary rounded-2xl p-8 text-center order-1 md:order-2 glow-cyan transform hover:translate-y-[-8px] transition-all relative md:bottom-2">
            ...
            <div className="mt-4">
              ...
              <p className="text-xs text-secondary font-semibold">{rankedEntries[0].title}</p>
            </div>
              ...
              return (
                <div
                  ...
                  className={`px-4 py-3.5 rounded-xl border flex items-center justify-between gap-4 transition-all ${
                    isSelf
                      ? 'bg-secondary/10 border-secondary glow-mint active:scale-[0.99] hover:bg-secondary/15'
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className={`w-6 h-6 rounded-full flex items-center justify-center font-headline text-xs font-black ${
                      ...
                      player.rank === 2 ? 'bg-slate-400 text-on-surface' :
                      player.rank === 3 ? 'bg-amber-600/35 text-secondary' : 'bg-surface-container-high text-on-surface-variant'
                    }`}>
                      {player.rank}
                    </div>
