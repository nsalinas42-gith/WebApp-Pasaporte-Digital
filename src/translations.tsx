...
const DICTIONARY: Record<Language, Record<string, string>> = {
  es: {
    ...
    'mapa_colectivo_titulo': 'Mapa de Cartografía Colectiva',
    'mapa_colectivo_desc': 'Explora las geolocalizaciones en tiempo real y los últimos registros registrados por los aventureros de la dapp en el mapa oficial de Caracas.',
    'ultimo_registro': 'Último Registro o Check-In',
    'no_key_warning': 'Se requiere configurar una Clave de API de Google Maps válida en el panel de Secrets (.env) para visualizar el mapa.',
  ...
  en: {
    ...
    'mapa_colectivo_titulo': 'Collective Cartography Map',
    'mapa_colectivo_desc': 'Explore real-time geolocations and the latest check-ins registered by dapp adventurers on the official map of Caracas.',
    'ultimo_registro': 'Latest Check-In or Registration',
    'no_key_warning': 'A valid Google Maps API Key must be configured inside the Secrets panel (.env) to visualize the map.',
