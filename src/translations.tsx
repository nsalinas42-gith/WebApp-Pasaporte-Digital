...
const DICTIONARY: Record<Language, Record<string, string>> = {
  es: {
    ...
    'mapa_colectivo_desc': 'Explora las geolocalizaciones en tiempo real y los últimos registros de los aventureros en el mapa.',
  ...
  en: {
    ...
    'mapa_colectivo_desc': 'Explore real-time geolocations and the latest records of the adventurers on the map.',
