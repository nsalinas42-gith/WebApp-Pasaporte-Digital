...
const DICTIONARY: Record<Language, Record<string, string>> = {
  es: {
    ...
    'reclamando_tx': 'Procesando en Solana Devnet...',
    ...
    'progreso_incompleto_desc': '¡A mitad de camino! Completa el reto en {dest} para alcanzar el siguiente nivel. Sigue explorando para desbloquear nuevas regiones y recompensas exclusivas.',
    ...
    'editar_cuenta_section': 'Editar Cuenta e Información Personal',
    ...
    'titulo_honorifico_lbl': 'Título Honorífico',
    'correo_vinculado_lbl': 'Correo vinculado (Privy/Google)',
  ...
  en: {
    ...
    'reclamando_tx': 'Processing on Solana Devnet...',
    ...
    'progreso_incompleto_desc': 'Halfway there! Complete the challenge at {dest} to reach the next level. Keep exploring to unlock new regions and exclusive rewards.',
    ...
    'editar_cuenta_section': 'Edit Account & Personal Information',
    ...
    'titulo_honorifico_lbl': 'Honorary Title',
    'correo_vinculado_lbl': 'Linked Email (Privy/Google)',
